...
import com.event.java.controller.user.mservice.models.HttpResponse;
import com.event.java.controller.user.mservice.models.PaymentRequest;
import com.event.java.controller.user.mservice.models.PaymentResponse;
import com.event.java.controller.user.mservice.enums.*;
import com.event.java.controller.user.mservice.shared.constants.Parameter;
...
import com.event.java.controller.user.mservice.shared.utils.Encoder;
...
public class CreateOrderMoMo extends AbstractProcess<PaymentRequest, PaymentResponse> {
    ...
    public static PaymentResponse process(Environment env, String orderId, String requestId, String amount, String orderInfo, String returnURL, String notifyURL, String extraData, com.event.java.controller.user.mservice.enums.RequestType requestType, Boolean autoCapture) throws Exception {
        try {
    ...
    public PaymentRequest createPaymentCreationRequest(String orderId, String requestId, String amount, String orderInfo,
                                                           String returnUrl, String notifyUrl, String extraData, com.event.java.controller.user.mservice.enums.RequestType requestType, Boolean autoCapture) {
